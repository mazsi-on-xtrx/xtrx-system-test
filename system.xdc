...
set_property -dict {PACKAGE_PIN P3   IOSTANDARD LVCMOS33  DRIVE 4  SLEW SLOW  PULLUP TRUE} [get_ports GPS1PPS]
set_property -dict {PACKAGE_PIN N2   IOSTANDARD LVCMOS33  DRIVE 4  SLEW SLOW  PULLUP TRUE} [get_ports GPSTX]
set_property -dict {PACKAGE_PIN L1   IOSTANDARD LVCMOS33  DRIVE 4  SLEW SLOW  PULLUP TRUE} [get_ports GPSRX]
